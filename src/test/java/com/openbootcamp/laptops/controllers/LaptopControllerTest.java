...
class LaptopControllerTest {
    ...
    @DisplayName("Devuelve todas las laptops encontradas")
    @Test
    void findAll() {
    ...
    @DisplayName("Devuelve una Laptop por Id")
    @Test
    void findOneById() {
    ...
    @DisplayName("Crea un objeto Laptop")
    @Test
    void create() {
        ...
        assertEquals("SPRING TEST", result.getBrand());
    }
